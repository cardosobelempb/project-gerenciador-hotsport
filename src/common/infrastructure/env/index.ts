...
export const envSchema = z.object({
  ...
  ROUTEROS_HOST: z.string().default('192.168.88.1'),
  ROUTEROS_PORT: z.coerce.number().default(8728),
  ROUTEROS_USER: z.string().default('admin'),
  ROUTEROS_PASSWORD: z.string().default('admin'),
})
